...
import { Duplicate, Fullscreen, FullscreenClose } from "monday-ui-react-core/icons";
      ...
      {({ style, tokens, getLineProps, getTokenProps }) => (
        <Pre className={`pre ${isFullScreenMode ? "fullscreen" : ""}`} style={style}>
          <CopyToClipboard onCopy={popNotice} text={content}>
            <Icon iconSize={24} icon={Duplicate} />
          </CopyToClipboard>
          <Icon
            iconSize={24}
            icon={isFullScreenMode ? FullscreenClose : Fullscreen}
